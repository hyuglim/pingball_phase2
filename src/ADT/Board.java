 ...
 * Furthermore, server contains a synchronized list of boards to concurrent modifications by he server
 * onto boards.
 * 
...
public class Board extends TimerTask {
     ...
     * board is drawn, we're able to draw and represent each wall's neighbor. Each
     * wall knows its neighbors name.
